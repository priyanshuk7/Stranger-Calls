...
import com.example.strangercalls.Models.Interface;
import com.example.strangercalls.Models.User;
import com.example.strangercalls.R;
import com.example.strangercalls.databinding.ActivityNewCallingBinding;
...
public class NewCallingActivity extends AppCompatActivity {
    ...
    ActivityNewCallingBinding binding;
    String uniqueId = "";
    FirebaseAuth auth;
    String username = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNewCallingBinding.inflate(getLayoutInflater());
            ...
            FirebaseDatabase.getInstance().getReference()
                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                            ...
                            Glide.with(NewCallingActivity.this).load(user.getProfile())
